...
@Component({
  selector: 'zh-checkbox-new',
  templateUrl: './zh-checkbox-new.component.html',
  styleUrls: ['./zh-checkbox-new.component.scss']
})
export class ZhCheckboxNewComponent implements OnInit {
